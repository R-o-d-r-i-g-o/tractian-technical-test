  ...
  <>
    ...
    <div className="w-full min-h-min p-5">
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="w-full md:w-1/2 flex flex-row md:flex-col gap-4 md:gap-0 pt-12 font-normal leading-6">
          <div className="w-1/2">
            <span className="font-semibold text-base">Tipo de Equipamento</span>
            <div className="text-dark_gray">Motor Elétrico (Trifásico)</div>
          </div>
          <hr className="text-gray h-px mt-4 mb-6 hidden md:block" />
          <div className="w-1/2">
